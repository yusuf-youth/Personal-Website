export const translations = {
    EN: {
        home: {
            subheading: "Hi! I'm",
            heading: "Ramil",
            text: "Aspiring Frontend developer.",
            buttonLabel: "View Resume",
        },
        aboutMe: {
            title: "About Me",
            description:
                "An aspiring frontend developer passionate about creating clean, user-friendly web experiences.",
            startingText: "A frontend developer with",
            highlightedText:
        ...
        technologies: {
            title: "Technologies",
            description: "The core tools I use to bring ideas to life on the web.",
        },
        projects: {
            title: "Projects",
            description:
                "A showcase of my practical work — from interactive apps to clean, responsive layouts.",
            ...
            data: [
                ...
                },
                {
                    ...
                    links: [
                        {
                            text: "Live Demo",
                            href: "https://yusuf-youth.github.io/Counter-Pro/",
                            type: "live",
                        },
                        {
                            text: "GitHub Repo",
                            href: "https://github.com/yusuf-youth/Counter-Pro",
                            type: "repo",
                        },
                    ],
                },
    ...
    UA: {
        home: {
            subheading: "Привіт! Я",
            heading: "Раміль",
            text: "Початківець Frontend-розробник.",
            buttonLabel: "Переглянути резюме",
        },
        aboutMe: {
            title: "Про мене",
            description:
                "Початківець фронтенд-розробник, захоплений створенням чистого та зручного веб-інтерфейсу.",
            startingText: "Фронтенд-розробник з",
            highlightedText:
        ...
        technologies: {
            title: "Технології",
            description:
                "Основні інструменти, які я використовую, щоб втілити ідеї в життя в інтернеті.",
        },
        projects: {
            title: "Проєкти",
            description:
                "Вітрина моєї практичної роботи — від інтерактивних додатків до чистих, адаптивних макетів.",
            ...
            data: [
                ...
                },
                {
                    ...
                    links: [
                        {
                            text: "Жива демо",
                            href: "https://yusuf-youth.github.io/Plain/",
                            type: "live",
                        },
                        {
                            text: "Репозиторій GitHub",
                            href: "https://github.com/yusuf-youth/Plain",
                            type: "repo",
                        },
                    ],
                },
